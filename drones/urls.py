...
urlpatterns = [
    ...
    url(r'^competition-pilot/$', views.CompetitionPilot.as_view(), name=views.CompetitionPilot.name),
    ...
    url(r'^competition/$', views.Competition.as_view(), name=views.Competition.name),
